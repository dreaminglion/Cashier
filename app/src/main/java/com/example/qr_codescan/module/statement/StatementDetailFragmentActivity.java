 ...
 * Description:
 */
public class StatementDetailFragmentActivity extends AppCompatActivity {

    private static final String TAG = "StatementDetailFragmentActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String storeName = getIntent().getStringExtra("name");
        if (storeName != null || storeName != "" ){
            mTvStoreName.setText(storeName +"收款纪录");
        }

        if (mFragments != null && mFragments.size() < 1){
            mFragments.add(new StatementAllFragment());
            mFragments.add(new StatementAlipayFragment());
            mFragments.add(new StatementWeiXinFragment());
        }
    ...
    private void initView() {
        ...
        tvSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(StatementDetailFragmentActivity.this);
                View view = View.inflate(StatementDetailFragmentActivity.this, R.layout.date_dialog, null);
                ...
                tv_sure_date_chooser.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(StatementDetailFragmentActivity.this,
